...
public class GroupsCahtFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(getActivity() != null) {
            binding.recycleAllchat.setLayoutManager(new LinearLayoutManager(getContext()));
            binding.recycleAllchat.addItemDecoration(new DividerItemDecoration(this.requireActivity(), LinearLayout.VERTICAL));
            List<en_chat> list = Appdatabase.getInstance(getContext()).getChatDAO().select_cat("Groups");
